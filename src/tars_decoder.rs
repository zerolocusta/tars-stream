...
impl TarsDecoder {
    ...
    fn return_error_if_required_not_found<T>(
        ...
        match e {
            ...
            DecodeErr::TagNotFoundErr => if is_required {
                Err(e)
            } else {
                Ok(default_value)
            },
...
pub trait TarsDecodeSimpleTrait {
    ...
    fn read_uint8(&self, tag: u8, is_required: bool, default_value: u8) -> Result<u8, DecodeErr>;
    fn read_uint16(&self, tag: u8, is_required: bool, default_value: u16)
        -> Result<u16, DecodeErr>;
    fn read_uint32(&self, tag: u8, is_required: bool, default_value: u32)
        -> Result<u32, DecodeErr>;

    fn read_float(&self, tag: u8, is_required: bool, default_value: f32) -> Result<f32, DecodeErr>;
    fn read_double(&self, tag: u8, is_required: bool, default_value: f64)
...
impl TarsDecodeSimpleTrait for TarsDecoder {
    ...
    fn read_boolean(
        ...
        self.read_int8(tag, is_required, default_value as i8)
            .map(|i| i != 0)
    }
    ...
    fn read_uint16(
        ...
        self.read_int32(tag, is_required, default_value as i32)
            .map(|i| i as u16)
    }
    ...
    fn read_uint32(
        ...
        self.read_int64(tag, is_required, default_value as i64)
            .map(|i| i as u32)
    }
